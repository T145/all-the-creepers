...
public class LayerCharge implements LayerRenderer<EntityCreeper> {

	private static final ResourceLocation LIGHTNING_TEXTURE = new ResourceLocation("textures/entity/creeper/creeper_armor.png");
	private final RenderLiving creeperRenderer;
	private final ModelBase creeperModel;

	public LayerCharge(RenderLiving creeperRenderer, ModelBase creeperModel) {
		this.creeperRenderer = creeperRenderer;
		this.creeperModel = creeperModel;
	}

	public LayerCharge(RenderLiving creeperRenderer) {
