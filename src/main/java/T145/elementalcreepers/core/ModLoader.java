...
import T145.elementalcreepers.entities.EntityDemolitionCreeper;
...
import T145.elementalcreepers.entities.EntityLavaCreeper;
...
class ModLoader {
	...
	static class ServerLoader {
		...
		private static final BiomeDictionary.Type[] VALID_BIOME_TYPES = { BiomeDictionary.Type.FOREST,
				BiomeDictionary.Type.HILLS, BiomeDictionary.Type.SWAMP, BiomeDictionary.Type.JUNGLE,
				BiomeDictionary.Type.WASTELAND, BiomeDictionary.Type.MAGICAL, BiomeDictionary.Type.BEACH,
				BiomeDictionary.Type.SANDY, BiomeDictionary.Type.SNOWY, BiomeDictionary.Type.MOUNTAIN };
		...
		public static void registerEntities(final RegistryEvent.Register<EntityEntry> event) {
			...
			final EntityEntry[] entries = {
					createCreeperBuilder("CakeCreeper").entity(EntityCakeCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("CookieCreeper").entity(EntityCookieCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("DarkCreeper").entity(EntityDarkCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("EarthCreeper").entity(EntityEarthCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("EnderCreeper").entity(EntityEnderCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("FireCreeper").entity(EntityFireCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("FireworkCreeper").entity(EntityFireworkCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("FurnaceCreeper").entity(EntityFurnaceCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("FriendlyCreeper").entity(EntityFriendlyCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("GhostCreeper").entity(EntityGhostCreeper.class).build(),
					createCreeperBuilder("BallisticCreeper").entity(EntityBallisticCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("IceCreeper").entity(EntityIceCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("IllusionCreeper").entity(EntityIllusionCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("LightCreeper").entity(EntityLightCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("LightningCreeper").entity(EntityLightningCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("LavaCreeper").entity(EntityLavaCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("PsychicCreeper").entity(EntityPsychicCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("ReverseCreeper").entity(EntityReverseCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("SpiderCreeper").entity(EntitySpiderCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("SpringCreeper").entity(EntitySpringCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("DemolitionCreeper").entity(EntityDemolitionCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("WaterCreeper").entity(EntityWaterCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("WindCreeper").entity(EntityWindCreeper.class).egg(0x0DA70B, 0x101010).build(),
					createCreeperBuilder("ZombieCreeper").entity(EntityZombieCreeper.class).egg(0x0DA70B, 0x101010).build()
			};
		...
		private static <C extends Entity> EntityEntryBuilder<C> createCreeperBuilder(final String name) {
			...
			return builder.id(registryName, entityId++).name(ElementalCreepers.MODID + ":" + name).tracker(80, 3, true);
		}
		...
		private static void copyCreeperSpawns(final Class<? extends EntityLiving> classToAdd) {
			for (final Biome biome : ForgeRegistries.BIOMES) {
				biome.getSpawnableList(EnumCreatureType.MONSTER).stream()
				.filter(entry -> entry.entityClass == EntityCreeper.class).findFirst()
				.ifPresent(spawnListEntry -> biome.getSpawnableList(EnumCreatureType.MONSTER)
						.add(new Biome.SpawnListEntry(classToAdd, spawnListEntry.itemWeight, spawnListEntry.minGroupCount, spawnListEntry.maxGroupCount)));
			}
		}
